                ...
                <div
                    ...
                    <div class="py-4 text-left px-6">
                        ...
                        <div class="flex justify-between items-center pb-4">
                            ...
                            <div class="modal-close cursor-pointer z-50" @click="modalVisibility">
                        ...
                        <ul class="flex flex-wrap mb-4">
                            <li class="flex-auto text-center">
                                <a class="block rounded py-3 px-4 transition" href="#" @click.prevent="tab = 'login'"
                                    :class="{
                                        'hover:text-white text-white bg-gray-700': tab === 'login',
                                        'hover:text-gray-700': tab === 'register',
                                    }">Login</a>
                            </li>
                            <li class="flex-auto text-center">
                                <a class="block rounded py-3 px-4 transition" href="#" @click.prevent="tab = 'register'"
                                    :class="{
                                        'hover:text-white text-white bg-gray-700': tab === 'register',
                                        'hover:text-gray-700': tab === 'login',
                                    }">Register</a>
                            </li>
                        </ul>
